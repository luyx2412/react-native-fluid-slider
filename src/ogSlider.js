...
import THUMB_RIGHT from '../img/rightSide.png';
import THUMB_LEFT_SMALL from '../img/leftSideSmall.png';
import THUMB_RIGHT_SMALL from '../img/rightSideSmall.png';
...
export default class Slider extends PureComponent {
  ...
  renderThumbSides = (thumbSide, isSmall, thumbTintColor) => {
    const leftSide = (
      <Image
        style={{
          top: 0.5,
          left: isSmall ? 3 : 0,
          position: 'absolute',
          height: isSmall ? 17 : 23,
          width: isSmall ? 16 : 16,
          tintColor: thumbTintColor,
          backgroundColor: 'transparent',
        }}
        resizeMode={'contain'}
        source={THUMB_RIGHT_SMALL}
      />
    );
    const rightSide = (
      <Image
        ...
        resizeMode={'contain'}
        source={THUMB_LEFT_SMALL}
      />
    );
    if (thumbSide === 'left') {
      return leftSide;
    } else if (thumbSide === 'right') {
      return rightSide;
    }
    return null;
  };
  ...
  render() {
    ...
    const isSmall = thumbMode === -1 || thumbMode === 0;
    ...
    return (
      ...
      >
        ...
        <Animated.View
          ...
          renderToHardwareTextureAndroid
          style={[
            defaultStyles.thumbContainer,
            {
              transform: [{ translateX: thumbLeft }, { translateY: 0 }],
              ...valueVisibleStyle,
              ...this.getStyles(thumbMode),
            },
          ]}
        >
          {thumbMode === 1 || thumbMode === 0
            ? this.renderThumbSides('left', isSmall, thumbTintColor)
            : null}
          <View
            style={{
          ...
          />
          {thumbMode === -1 || thumbMode === 0
            ? this.renderThumbSides('right', isSmall, thumbTintColor)
            : null}
        </Animated.View>
        <View
          renderToHardwareTextureAndroid
